...
@section('content')
    ...
    <div class="mb-8">
        ...
        @if($errors->has('login'))
            <div class="text-red-500 text-sm mt-1 absolute">{{ $errors->first('login') }}</div>
        @endif
    </div>
    ...
    <div class="mb-8">
        ...
        @if($errors->has('car'))
            <div class="text-red-500 text-sm mt-1 absolute">{{ $errors->first('car') }}</div>
        @endif
    </div>
    ...
    <div class="mb-8">
        ...
        @if($errors->has('car_year'))
            <div class="text-red-500 text-sm mt-1 absolute">{{ $errors->first('car_year') }}</div>
        @endif
    </div>
